...
public class DateTime {
     ...
     * @author Allen Zhang
     */
    public static String getCurrentDate_YYMMDDHHMMSSWithOutSeparator() {
        return convertDateTime(new Date(), "yyMMddHHmmss");
    }
    /////////////////////////////////////////////////////////////////////////////////////
     ...
     *
     * @param day
     * @return 创建日期:Apr 2, 2010-9:36:07 AM
     * @author jh
     */
     ...
     * @author jh
     */
    public static String getNextYear_YYYYMMDD(String day) {
        Date date = DateTime.parseDateTime_YYYYMMDD(day);
        Date tomorrowDate = DateTime.addMonths(date, 12);
